...
import { User, Lock, ArrowLeft, Leaf, Loader2, Sparkles, ShieldCheck, Mail, Phone, ArrowRight, X } from "lucide-react";
...
const SellerLogin = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (!username || !password || !email || !mobile) {
      setError("All fields are required for curator access.");
      return;
    }
  ...
  return (
    <div className="min-h-screen flex bg-[#faf9f6] font-sans selection:bg-emerald-200 overflow-hidden">
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 md:p-20 bg-[#faf9f6] overflow-y-auto">
        <motion.div 
        ...
        >
          ...
          <div className="space-y-10">
            ...
            <form onSubmit={handleLogin} className="space-y-8">
              {/* Username Input */}
              <div className="group">
                <label className="text-[10px] font-black text-stone-400 uppercase tracking-[0.3em] mb-3 block group-focus-within:text-emerald-600 transition-colors">Curator Alias</label>
              ...
              {/* Email Input */}
              <div className="group">
                <label className="text-[10px] font-black text-stone-400 uppercase tracking-[0.3em] mb-3 block group-focus-within:text-emerald-600 transition-colors">Registry Email</label>
                <div className="relative border-b border-stone-200 group-focus-within:border-emerald-500 transition-all pb-2">
              ...
              {/* Mobile Input */}
              <div className="group">
                <label className="text-[10px] font-black text-stone-400 uppercase tracking-[0.3em] mb-3 block group-focus-within:text-emerald-600 transition-colors">Mobile Index</label>
                <div className="relative border-b border-stone-200 group-focus-within:border-emerald-500 transition-all pb-2">
